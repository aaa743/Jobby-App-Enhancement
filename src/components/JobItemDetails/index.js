...
class JobItemDetails extends Component {
  ...
  // ఫార్మాటింగ్ మెథడ్స్ పేర్లు మార్చాను
  formatSimilarJobsData = eachItem => ({
  ...
  fetchJobInformation = async () => {
    ...
    if (response.ok) {
      ...
      const updatedJobDetails = this.formatJobDetailsData(fetchedData.job_details)
      const updatedSimilarJobs = fetchedData.similar_jobs.map(job =>
        this.formatSimilarJobsData(job),
      )
      this.setState({
  ...
  renderJobItemFailure = () => (
    <div className="job-item-error-view-container">
      ...
      <button
        ...
        onClick={this.fetchJobInformation}
      >
        Retry
      </button>
    </div>
        ...
        <div className="job-item">
          ...
          <div className="description-visit-container">
            ...
            <div className="visit-container">
              <a href={companyWebsiteUrl} className="visit-heading" target="_blank" rel="noreferrer">
                Visit
              </a>
